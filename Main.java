...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("-------------------");
        }catch (ArithmeticException arithmetic_e)
        {
    ...
    public static void checkException(int count) throws Exception
    {
        if(count <= 0) {
            throw new Exception(" Please enter number bigger than zero");
        }
    }
    public static void checkEx(int num) throws Exception
    {
        if(num < 0)
            throw new Exception("The input lees than 0");
    }
}